...
rcsid	db	"$Id: tmap_pnt.asm 1.2 1996/02/01 14:53:00 matt Exp $"
	align	4
...
_TEXT	segment	para public USE32 'CODE'
	...
	extn	asm_tmap_scanline_qnt_

public asm_tmap_scanline_pnt_
asm_tmap_scanline_pnt_:
	cmp	_bytes_per_row, 320
	jbe	@f
	jmp	asm_tmap_scanline_qnt_
@@:

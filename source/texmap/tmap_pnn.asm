...
rcsid	db	"$Id: tmap_pnn.asm 1.2 1996/02/01 14:53:00 matt Exp $"
	align	4
...
_TEXT	segment	para public USE32 'CODE'
	...
	extn	asm_tmap_scanline_qnn_

public asm_tmap_scanline_pnn_
asm_tmap_scanline_pnn_:
	cmp	_bytes_per_row, 320
	jbe	@f
	jmp	asm_tmap_scanline_qnn_
@@:

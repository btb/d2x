...
rcsid	db	"$Id: tmap_plt.asm 1.2 1996/02/01 14:52:59 matt Exp $"
	align	4
...
_TEXT	segment	para public USE32 'CODE'
	...
	extn	asm_tmap_scanline_qlt_

public asm_tmap_scanline_plt_
asm_tmap_scanline_plt_:
	cmp	_bytes_per_row, 320
	jbe	@f
	jmp	asm_tmap_scanline_qlt_
@@:

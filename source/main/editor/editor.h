...
extern   sbyte    Vertex_active[MAX_VERTICES]; // !0 means vertex is in use,
                                               //  0 means not in use.
...
extern   sbyte Been_visited[];            // List of segments visited in a
                                          //  recursive search, if element n
                                          //  set, segment n done been visited

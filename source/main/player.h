...
typedef struct player {
   ...
   sbyte    level;                     // Current level player is playing.
                                       //  (must be signed for secret levels)
   ...
   sbyte    hours_level;               // Hours played (since time_total can
                                       //  only go up to 9 hours)
   sbyte    hours_total;               // Hours played (since time_total can
                                       //  only go up to 9 hours)
} player;

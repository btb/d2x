...
typedef struct robot_info {
   ...
   sbyte    weapon_type;
   sbyte    weapon_type2;     // Secondary weapon number, -1 means none,
   ...
   sbyte    contains_prob;    // Probability that this instance will contain
                              //  something in N/16
   sbyte    contains_type;    // Type of thing contained, robot or powerup, in
                              //  bitmaps.tbl, !0=robot, 0=powerup
   sbyte    kamikaze;         // !0 means commits suicide when hits you,
                              //  strength thereof. 0 means no.

   short       score_value;                  // Score from this robot.
   sbyte    badass;           // Dies with badass explosion, and strength
                              //  thereof, 0 means NO.
...
// -- unused, mk, 05/25/95 fix      shield[NDL];                     // shield strength of this robot
   ...
   sbyte    evade_speed[NDL];       // rate at which robot can evade shots,
                                    //  0=none, 4=very fast
   ...
   sbyte    smart_blobs;         // how many smart blobs are emitted when this
                                 //  guy dies!
   sbyte    energy_blobs;        // how many smart blobs are emitted when this
                                 //  guy gets hit by energy weapon!

   sbyte    thief;               // !0 means this guy can steal when he
                                 //  collides with you!
   sbyte    pursuit;             // !0 means pursues player after he goes
                                 //  around a corner.  4 = 4/2 pursue up to 4/2
                                 //  seconds after becoming invisible if up to
                                 //  4 segments away
   sbyte    lightcast;           // Amount of light cast. 1 is default.
                                 //  10 is very large.
   sbyte    death_roll;          // 0 = dies without death roll.
                                 //  !0 means does death roll,
                                 //  larger = faster and louder

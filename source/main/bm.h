...
extern sbyte ObjType[MAX_OBJTYPE];     // Type of an object, such as Robot,
                                       //   eg if ObjType[11] == OL_ROBOT,
                                       //   then object #11 is a robot
extern sbyte ObjId[MAX_OBJTYPE];       // ID of a robot, within its class,
                                       //   eg if ObjType[11] == 3,
                                       //   then object #11 is the third robot

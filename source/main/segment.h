...
#ifdef COMPACT_SEGS
typedef struct side {
   sbyte    type;                         // replaces num_faces and tri_edge,
                                          //  1 = quad, 2 = 0:2 triangulation,
                                          //  3 = 1:3 triangulation
...
// sbyte    matcen_num;                   // which center segment is associated
//                                        // with.
// short    value;
...
extern   sbyte    Side_to_verts[MAX_SIDES_PER_SEGMENT][4];
   // Side_to_verts[my_side] is list of vertices forming side my_side.

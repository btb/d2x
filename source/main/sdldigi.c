...
typedef struct digi_channel {
   ...
   int      handle;        // What SS handle this is playing on
...
SDL_bool DIGIDriverInit = SDL_FALSE;
...
static SDL_bool MIDIDriverInit = SDL_FALSE;
...
void * digi_load_file( char *szFileName, char *hmem, int * length );
...
//extern SDL_bool WMidi_NewStream;
